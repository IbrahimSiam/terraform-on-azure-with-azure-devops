...
sudo echo "This is My Test Application For Azure DevOps CI/CD - WebVM App1 - VM Hostname: $(hostname)" > /var/www/html/app1/hostname.html
sudo echo "This is My Test Application For Azure DevOps CI/CD - WebVM App1 - App Status Page" > /var/www/html/app1/status.html
